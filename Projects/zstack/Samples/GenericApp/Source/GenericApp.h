...
#define GENERICAPP_P2P_CLUSTERID       4
...
#define GENERIC_FLASH_GROUP                  0x0001
...
//于 Project-Options-C/C++Compiler-Preprocessor-Defined symbols处添加 CNIOT 即启用CNiot开发库
#ifdef CNIOT  
...
#define CNIOT_LOOP_TASK_EVT       0x0002
#define CNIOT_LOOP_TASK_TIMEOUT   10     // Every 1 ms
